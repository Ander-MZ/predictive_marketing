...
import simulated_transactions as sim

alpha = 0.75

tree = cElementTree.parse("../results/1test.xml")
...
for card in cards:
	...
	allHistory.append(history[:n_t])
	allEvaluation.append(history[n_t:])

print "Precision: " , evaluate(allHistory,allEvaluation,3)
